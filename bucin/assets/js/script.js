...
// Dirubah 
const pengirim = "Mi Amorr 🌹";
const nomorWa = "6281316882187" // awalan nomor 0 harus di awalin 62
const textWa = "AKU SAYANG BANGET SAMA KAMU"
const pesan = `aku cuma mau bilang sama kamu, jangan sedih-sedih yah kesayangan aku, aku disini akan selalu nemenin kamu, walaupun mungkin aku berbeda dengan temen kamu, tapi aku akan selalu siap dan berusaha untuk menemani kmuu.
 nanti kita seru-seru bareng ya cantik...`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Kalau mau tau, ketik mau dibawah ini yaaa',
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`Ketik MAU dulu sayangkuuu`)
      }
      return { login }
    }
  }).then((result) => {
    ...
    let txt = `Karena kamu udah ketik ${result.value.login}, ${pesan}`;
